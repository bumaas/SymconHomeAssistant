    ...
    public function buildDeviceConfig(array $group): array
    {
        ...
        foreach ($entities as $entity) {
            ...
            $deviceConfig['entities'][] = [
                ...
                'latest_version_topic' => (string)(($entity['transport']['latest_version_topic'] ?? '') ?: ''),
                ...
                'payload_lock'      => $entity['state']['payload_lock'] ?? null,
                'payload_unlock'    => $entity['state']['payload_unlock'] ?? null,
                'payload_open'      => $entity['state']['payload_open'] ?? null,
                'event_payload'     => $entity['state']['event_payload'] ?? null,
                'state_on'          => $entity['state']['state_on'] ?? null,
                'state_off'         => $entity['state']['state_off'] ?? null,
                'state_locked'      => $entity['state']['state_locked'] ?? null,
                'state_unlocked'    => $entity['state']['state_unlocked'] ?? null,
                'state_locking'     => $entity['state']['state_locking'] ?? null,
                'state_unlocking'   => $entity['state']['state_unlocking'] ?? null,
                'state_jammed'      => $entity['state']['state_jammed'] ?? null,
                'options'           => $entity['state']['options'] ?? [],
                'metadata'          => [
                    'device_class'       => $entity['state']['device_class'] ?? null,
                    'source_type'        => $entity['state']['source_type'] ?? null,
                    'state_class'        => $entity['state']['state_class'] ?? null,
                    'unit'               => $entity['state']['unit_of_measurement'] ?? null,
                    'content_type'       => $entity['state']['content_type'] ?? null,
                    'latest_version_template' => $entity['state']['latest_version_template'] ?? null,
                    'title'              => $entity['state']['title'] ?? null,
                    'release_summary'    => $entity['state']['release_summary'] ?? null,
                    'release_url'        => $entity['state']['release_url'] ?? null,
